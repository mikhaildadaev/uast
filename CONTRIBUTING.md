...
1.  **Check for existing issues.** Search for similar issues in the [Issues](https://github.com/mikhaildadaev/uast/issues) section.
...
**Important:** The uast projects are dual-licensed (AGPLv3 + Commercial). To protect this model, we require a signed Individual Contributor License Agreement (CLA) for all significant contributions.

Please read the full [CLA](https://github.com/mikhaildadaev/uast/blob/main/CLA.md)
