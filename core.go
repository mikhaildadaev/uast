...
var (
	...
	ErrExcessLenghtArray                  = errors.New("excess lenght array")
	ErrExcessLenghtData                   = errors.New("excess lenght data")
	ErrExcessLenghtLimit                  = errors.New("excess lenght limit")
	ErrExcessMaxComparison                = errors.New("excess max comparison")
	ErrExcessMaxDepth                     = errors.New("excess max depth")
	ErrExcessMaxField                     = errors.New("excess max field")
	...
	ErrInvalidConstraintCheck             = errors.New("invalid constraint check")
	ErrInvalidConstraintForeignKey        = errors.New("invalid constraint foreign key")
	ErrInvalidConstraintPrimaryKey        = errors.New("invalid constraint primary key")
	ErrInvalidConstraintUnique            = errors.New("invalid constraint unique")
	...
	ErrUnsupportEntityView                = errors.New("unsupport entity view")
