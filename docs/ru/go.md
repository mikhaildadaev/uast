...
## Limits
- **DDL пока нет**: ALTER, CREATE, COMMENT, DROP, TRUNCATE ожидаются в v2.
...
::: tip **Примечание** 
Библиотека не проверяет версию сервера во время выполнения. Использование функций на более старых версиях приведёт к ошибкам SQL со стороны базы данных. Убедитесь, что ваша база данных соответствует минимальным требованиям к версии.
:::